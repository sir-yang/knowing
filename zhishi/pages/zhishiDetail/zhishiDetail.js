    ...
    detailEvent(event) {
        ...
        if (dataset.types === 'tab') {
            ...
            if (Number(this.data.details.letter) === 0) {
                wx.navigateTo({
                    url: '/common/pages/privateMsgDetail/privateMsgDetail?uid=' + this.state.options.id
                })
            } else {
            ...
            wx.navigateTo({
                url: '/zhishi/pages/coursesDetail/coursesDetail?id=' + dataset.id
            })
            ...
            let index = dataset.index;
            wx.navigateTo({
                url: '/enjoy/pages/enjoyDetail/enjoyDetail?id=' + list[index].id
            })
            ...
            wx.navigateTo({
                url: '/common/pages/attentionList/attentionList?uid=' + details.id + '&status=' + status
            })
